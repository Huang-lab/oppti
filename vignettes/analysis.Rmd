...
cohort. Lets generate a toy proteomics data for a cohort of 30 tumor samples,
...
sample3, suggesting a protruding expression in the tumor tissue of sample3
...
expected in the observed tumor state compared to the normal state. The
...
proteomics data for a separate cohort of 20 tumor samples, each quantifying 80
proteins (say, 50 of which are overlapping with those quantified in the first
cohort).
```{r, eval = TRUE}
